...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.btn_volume = ft.ElevatedButton(text="Calcola Volumi",disabled=True, on_click=self._controller.handle_volume)
        ...
        self.btn_path = ft.ElevatedButton(text="Calcola percorso", disabled=True, on_click=self._controller.handle_path)
